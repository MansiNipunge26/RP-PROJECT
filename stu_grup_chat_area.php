...
<html>
  ...
  <body>
      <?php 
        ...
        //$outgoing_msg_id = $_SESSION['stu_unique_id'];
        ...
        <div class="container-fluid chat_content">
          <div class="row">
            <div class="col-xl-12 chat_main_content">
              ...
              <!-- CHAT AREA START -->
               <div class="col-xl-12 col-sm-12 px-0 d-flex align-self-center justify-content-center">
                  <div class="col-xl-5 col-lg-7 col-md-10 col-sm-12 chat_wrapper px-0">
                    <div class="col-xl-12 col-sm-12 chat_account d-flex justify-content-between align-items-center">
                      <a class="account_holder_title chat_aht text-dark d-flex align-items-center">
                        <?php
                          $row = mysqli_fetch_assoc(mysqli_query($conn,"SELECT * FROM `grups` WHERE grup_id = $grup_id"));
                          $query = mysqli_query($conn,"SELECT * FROM `grup_member` gm INNER JOIN `login` lg ON gm.member_id = lg.unique_id  WHERE grup_id = $grup_id AND unique_id != $unique_id");
                          echo '
                                  <div>
                                    <img class="img" src="'.$row['grup_img'].'" alt="">  
                                  </div>
                                  <div>
                                    <p>'.$row['grup_name'].'</p>';
                          echo '<p class="member_para text-secondary">You, ';
                    ...
                    <div class="chat_middle_are" style="display: flex;flex-direction: column-reverse;">
                      ...
                      <form action="" class="msg_send_form w-100 px-0">
                        <div class="col-xl-12 col-sm-12 justify-content-center chat_end_area d-flex">
                            <input type="number" id="grup_id" value="<?php echo($grup_id); ?>" hidden>
                            <!-- <input type="number" id="outgoing_msg_id" value="<?php //echo($outgoing_msg_id); ?>" hidden> -->
                              ...
                              <button class="btn btn-dark btn-sm px-3 py-0 mt-3" id="send_btn"> <span class="fa fa-paper-plane"></span></button>
                        </div>
                      </form>
              </div>
              <!-- CHAT AREA END -->
